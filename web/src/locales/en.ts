...
export const en = {
  ...
  'how.step3': 'Business releases contact',
  'how.step4': 'Connect directly',
  'home.verticals': 'Every function your business needs',
  ...
  'exp.step3.body': 'When a business shows real interest.',
  ...
  'cat.entry.expert': 'Are you an expert in this category? Apply to see open needs',
  'cat.tile.business': 'Need help in {category}? Post your project free →',
  'cat.tile.expert': 'Work in {category}? See open needs →',
  'cat.expand': 'View sub-categories',
  'cat.collapse': 'Hide sub-categories',
  ...
  'pay.step2.body': 'See or apply to real opportunities.',
  'pay.step3.title': 'Pay only for real interest',
  'pay.step3.body': 'A fixed, transparent fee, only once a business chooses you.',
  'pay.compare1': 'A fraction of a typical recruiter or project fee (15–25% of annual salary)',
  'pay.compare2': 'Far less than running your own lead-generation advertising',
  ...
  'faq.q6': 'How long can I see the contact details?',
  'faq.a6': '5 calendar days, on partly.asia only. Both sides receive each other’s details at the same time.',

  // Sharing
  'share.badge.text': 'Hire me on partly.asia',
  'share.badge.prompt': 'Add this to your LinkedIn profile so businesses can find and apply to work with you directly.',
  'share.invite.business':
    'Know another business owner who needs expert help at a fraction of market investment? Invite them to post their first project free.',
  'share.invite.expert':
    'Know another expert, consultant, or trainer who needs more leads? Invite them to join and start receiving warm leads.',
